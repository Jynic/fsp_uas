        ...
        $("#cbokategori").change(function(){
            ...
            if(kategori == "kumpulancerita"){
                ...
                (data){
                    var ceritas1 = JSON.parse(data);
                    $.each(ceritas1, function(i, item){
                        $("#card_cerita").append("<div id='"+item.idcerita+"' class='card_cerbung_kecil'><h2 class='judulCeritaku'>"+item.judul+"</h2><p class='isicard'>Pemilik : "+item.nama+"</p><br><p class='isicard'>Jumlah Paragraf : "+item.jumlah_paragraf+"</p><a href class='isicard'>Baca Lebih Lanjut</a></div>");
                    });
