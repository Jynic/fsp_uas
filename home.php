                ...
                <script>
                    ...
                    (data){
                        ...
                        $.each(ceritas, function(i, item){
                            $(".cerita_saya").append("<div id='"+item.idcerita+"' class='card_cerbung'><h2 class='judulCeritaku'>"+item.judul+"</h2><p class='isicard'>Jumlah Paragraf : "+item.jumlah_paragraf+"</p><a href class='isicard'>Baca Lebih Lanjut</a></div>");
                        });
    ...
    <div id='Hide-Container'>
        ...
        <div id='Container-Kecil'>
            ...
            <div id='card_cerita'>
                ...
                ?>
                <script>
                    $.post('ajax_paging_kanan.php', {iduser:id, limit:4}).done(function
                        (data){
                            var ceritas = JSON.parse(data);
                            $.each(ceritas, function(i, item){
                ...
                $("#cbokategori").change(function() {
                    ...
                    if(kategori == "kumpulancerita"){
                        ...
                        (data){
                            var ceritas = JSON.parse(data);
                            $.each(ceritas, function(i, item){
                                $("#card_cerita").append("<div id='"+item.idcerita+"' class='card_cerbung_kecil'><h2 class='judulCeritaku'>"+item.judul+"</h2><br><p class=''>Jumlah Paragraf : "+item.jumlah_paragraf+"</p><a href class='isicard'>Baca Lebih Lanjut</a></div>");
                            });
                            $(".card_cerita").append("<button id='btnTampilKumpulanCerita'>Tampilkan Cerita Selanjutnya</button>");
                            $("#btnTampilKumpulanCerita").click(function(){
                        window.location.href = "home.php?limitkecil=100";
